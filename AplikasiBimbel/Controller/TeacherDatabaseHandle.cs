...
{
    public class TeacherDatabaseHandle
    {
        ...
        //Column Names
        public readonly string[] columnNames = { "Teacher_ID", "Username", "Password", "Name", "Address", "PhoneNumber", "Permission", "Status", "DateIn", "DateOUt" };
